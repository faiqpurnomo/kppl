            ...
            <div class="container" style="padding:20px;">
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <h3></h3>
                        <h3>Apa yang akan anda lakukan hari ini?</h3> 
                    </div>
                </div>
                <div class="row" style="padding:50px">
                    <div class="col-md-6 text-center">
                        <h3>Print Online</h3> 
                        <p>Menu untuk Print Online</p>
                        <a href="<?php echo site_url('user/showPrint')?>">
                            <img src="https://image.flaticon.com/icons/svg/201/201579.svg" width="30%" class="img-thumbnail text-center" /> 
                        </a>
                    </div>
                    <div class="col-md-6 text-center">
                        <h3>histori transaksi</h3> 
                        <p>Menu untuk melihat histori transaksi</p>
                        <a href="<?php echo site_url('user/readData')?>">
